...
bool CMFCApplication1Doc::getDraw()
{
	return draw;
}

void CMFCApplication1Doc::setDraw(bool draw)
{
	this->draw = draw;
}

bool CMFCApplication1Doc::getFirst()
{
	return first;
}

void CMFCApplication1Doc::setFirst(bool first)
{
	this->first = first;
}
